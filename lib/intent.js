...
export function detectWorkdirIntent(text) {
  const n = normalizeIntentText(text);
  return (
    n.includes('en que ruta estas') ||
    n.includes('en que ruta te encuentras') ||
    n.includes('en que directorio estas') ||
    n.includes('en que carpeta estas') ||
    n.includes('cual es tu ruta') ||
    n.includes('donde estas') ||
    n.includes('donde te encuentras') ||
    n.includes('directorio de trabajo')
  );
}
