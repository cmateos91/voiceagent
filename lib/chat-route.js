    ...
    try {
      ...
      if (suggestionTarget) {
        ...
        if (memory.pendingIntent === 'summary') {
          ...
          return streamDeferredSummary(
            ...
            () => summarizeExecution(filledMessage, execution, { target: memory.lastTarget }),
      ...
      if (summaryIntent) {
        ...
        return streamDeferredSummary(
          ...
          () => summarizeExecution(filledMessage, execution, { target: resolvedTargetFromContext }),
          'summary_execution'
        );
      }

      if (listingIntent) {
        const fallbackTarget = referencesPreviousTarget(filledMessage) ? memory.lastTarget : '.';
