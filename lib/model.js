...
export async function askModel(history, lastUserMessage, memoryContext = '', onToken, context = {}) {
  ...
  const system = {
    ...
    content:
      ...
      '- Para abrir el bloc de notas o editor de texto en linux: xdg-open /tmp/nuevo.txt. Para abrir el navegador: xdg-open https://google.com. Para abrir una carpeta: xdg-open <ruta>. En windows usa start o notepad según el caso. ' +
      '- Nunca uses nombres de aplicaciones específicas (gedit, kate, nautilus) salvo que el usuario los mencione explícitamente. ' +
